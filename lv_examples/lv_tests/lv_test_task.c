...
static void delay_task2(void * param);
...
void lv_test_task_1(void)
{
    ...
    static lv_test_task_dsc_t dsc[] = {				
        {.name = "highest", .prio = LV_TASK_PRIO_HIGHEST, .period = 50, .delay = 0},
        {.name = "high", .prio = LV_TASK_PRIO_HIGH, .period = 50, .delay = 0},
        {.name = "mid", .prio = LV_TASK_PRIO_MID, .period = 50, .delay = 0},
        {.name = ""}
    };
