...
#if EVDEV_SCALE
#define EVDEV_SCALE_HOR_RES     	(3500)          /* Horizontal resolution of touchscreen */
#define EVDEV_SCALE_HOR_RES2     	(1000)          /* Horizontal resolution of touchscreen */

#define EVDEV_SCALE_VER_RES     	(1000)          /* Vertical resolution of touchscreen */
#define EVDEV_SCALE_VER_RES2     	(3800)          /* Vertical resolution of touchscreen */
	
#endif  /*EVDEV_SCALE*/					
					
#define EVDEV_CALIBRATE         1               /*Scale and offset the touchscreen coordinates by using maximum and minimum values for each axis*/
#if EVDEV_CALIBRATE
#define EVDEV_HOR_MIN   1000                    /*If EVDEV_XXX_MIN > EVDEV_XXX_MAX the XXX axis is automatically inverted*/
#define EVDEV_HOR_MAX   3500
#define EVDEV_VER_MIN   1000
#define EVDEV_VER_MAX   3500							
#endif  /*EVDEV_SCALE*/
#endif  /*USE_EVDEV*/
